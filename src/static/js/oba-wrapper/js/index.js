const range = require('./modules/utils.js')
const detectPingError = require('./modules/ping.js')
const buildPong = require('./modules/ping.js')
const supressPingError = require('./modules/ping.js')
const PromiseStream = require('./modules/PromiseStream.js')
const XMLToJSON = require('./modules/Parser.js')
const handleJSONParserError = require('./modules/Parser.js')
const cleanAquabrowserJSON = require('./modules/Parser.js')
const smartRequest = require('./modules/SmartRequest.js')
